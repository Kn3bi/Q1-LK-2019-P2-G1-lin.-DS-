...
public class Startbildschirm extends InteractiveGraphicalObject {
    ...
    private SzenenButton anleitung;
    private SzenenButton spiel;
    ...
    public Startbildschirm(ViewController viewController, ProgramController pC){
        ...
        anleitung = new SzenenButton(100, 400, "Anleitung", 50, 150, 0, viewController);
        spiel = new SzenenButton(500, 400, "Zum Spiel", 50, 150, 2, viewController);
